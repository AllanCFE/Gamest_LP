        ...
        <div className={[styles.contactArea].join(" ")}>
            ...
            <div className={styles.cardTitle}>
                    ...
                    <div className={styles.footerLeft}>
                        ...
                        <div className={styles.smLogos}>
                            <a href='https://api.whatsapp.com/send?phone=5565999780487&text=Gostaria%20de%20conversar%20sobre%20o%20servi%C3%A7o%20de%20recrutamento%20da%20Gamest' target="_blank" className={styles.centerH}>
